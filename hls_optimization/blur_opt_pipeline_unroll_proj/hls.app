<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" projectType="C/C++" top="blur_opt_pipeline_unroll" name="blur_opt_pipeline_unroll_proj" ideType="classic">
    <files>
        ...
        <file name="../../testbench_opt.cpp" sc="0" tb="1" cflags="-DOPT_PIPELINE_UNROLL -Wno-unknown-pragmas" csimflags="" blackbox="false"/>
    </files>
    <solutions>
