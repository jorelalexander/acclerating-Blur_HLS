<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" projectType="C/C++" top="blur_opt_bitwidth" name="blur_opt_bitwidth_proj" ideType="classic">
    <files>
        ...
        <file name="../../testbench_opt.cpp" sc="0" tb="1" cflags="-DOPT_BITWIDTH -Wno-unknown-pragmas" csimflags="" blackbox="false"/>
    </files>
    <solutions>
