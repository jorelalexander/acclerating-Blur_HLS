set moduleName linebuffer_box3_base_unsigned_short_Pipeline_VITIS_LOOP_15_1_VITIS_LOOP_16_2
set isTopModule 0
...
set cdfgNum 8
set C_modelName {linebuffer_box3_base<unsigned short>_Pipeline_VITIS_LOOP_15_1_VITIS_LOOP_16_2}
