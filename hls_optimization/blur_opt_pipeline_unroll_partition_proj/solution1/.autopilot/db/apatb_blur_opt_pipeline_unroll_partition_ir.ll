; ModuleID = 'C:/BlurCALDAllComparisons/hls_optimization/blur_opt_pipeline_unroll_partition_proj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_blur_opt_pipeline_unroll_partition_ir([1024 x i8]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1024" %input, [1024 x i8]* noalias nocapture nonnull "fpga.decayed.dim.hint"="1024" %output, i32 %width, i32 %height) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_blur_opt_pipeline_unroll_partition_hw([1024 x [1024 x i8]]* %input_copy, [1024 x [1024 x i8]]* %output_copy, i32 %width, i32 %height)
...
declare void @apatb_blur_opt_pipeline_unroll_partition_hw([1024 x [1024 x i8]]*, [1024 x [1024 x i8]]*, i32, i32)
...
declare void @blur_opt_pipeline_unroll_partition_hw_stub([1024 x i8]* noalias nocapture nonnull readonly, [1024 x i8]* noalias nocapture nonnull, i32, i32)

define void @blur_opt_pipeline_unroll_partition_hw_stub_wrapper([1024 x [1024 x i8]]*, [1024 x [1024 x i8]]*, i32, i32) #5 {
entry:
  ...
  call void @blur_opt_pipeline_unroll_partition_hw_stub([1024 x i8]* %4, [1024 x i8]* %5, i32 %2, i32 %3)
