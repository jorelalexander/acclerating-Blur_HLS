...
using hls::sim::Byte;
extern "C" void blur_opt_pipeline_unroll_partition(Byte<1>*, Byte<1>*, int, int);
extern "C" void apatb_blur_opt_pipeline_unroll_partition_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, int __xlx_apatb_param_width, int __xlx_apatb_param_height) {
...
__xlx_input_r__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_input_r)[i]);
  ...
  int __xlx_size_param_input_r = 1048576;
...
__xlx_output_r__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_output_r)[i]);
  ...
  int __xlx_size_param_output_r = 1048576;
  int __xlx_offset_param_output_r = 0;
  int __xlx_offset_byte_param_output_r = 0*1;
  // DUT call
  blur_opt_pipeline_unroll_partition(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data(), __xlx_apatb_param_width, __xlx_apatb_param_height);
