...
__attribute__((sdx_kernel("blur_opt_pipeline_unroll_partition", 0))) void blur_opt_pipeline_unroll_partition(
    uint8_t input[MAX_HEIGHT][MAX_WIDTH],
    uint8_t output[MAX_HEIGHT][MAX_WIDTH],
    int width,
    int height
...
#pragma HLSDIRECTIVE TOP name=blur_opt_pipeline_unroll_partition
# 348 "blur_opt.cpp"
