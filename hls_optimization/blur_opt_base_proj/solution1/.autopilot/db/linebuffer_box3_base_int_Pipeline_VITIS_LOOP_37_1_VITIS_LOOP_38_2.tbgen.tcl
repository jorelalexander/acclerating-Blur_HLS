set moduleName linebuffer_box3_base_int_Pipeline_VITIS_LOOP_37_1_VITIS_LOOP_38_2
set isTopModule 0
...
set cdfgNum 8
set C_modelName {linebuffer_box3_base<int>_Pipeline_VITIS_LOOP_37_1_VITIS_LOOP_38_2}
