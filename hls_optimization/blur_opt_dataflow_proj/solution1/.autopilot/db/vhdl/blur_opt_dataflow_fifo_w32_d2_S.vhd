...
entity blur_opt_dataflow_fifo_w32_d2_S is 
    generic (
...
architecture rtl of blur_opt_dataflow_fifo_w32_d2_S is
...
------------------------Component----------------------
    component blur_opt_dataflow_fifo_w32_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_blur_opt_dataflow_fifo_w32_d2_S_ShiftReg : blur_opt_dataflow_fifo_w32_d2_S_ShiftReg
    generic map (
...
entity blur_opt_dataflow_fifo_w32_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end blur_opt_dataflow_fifo_w32_d2_S_ShiftReg;

architecture rtl of blur_opt_dataflow_fifo_w32_d2_S_ShiftReg is
