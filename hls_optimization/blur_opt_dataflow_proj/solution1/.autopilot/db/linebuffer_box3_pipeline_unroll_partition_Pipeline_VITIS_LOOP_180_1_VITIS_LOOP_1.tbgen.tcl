...
dict set ap_memory_interface_dict stage1 { MEM_WIDTH 8 MEM_SIZE 1048576 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
...
set portList { 
	...
	{ mul_ln180 sc_in sc_lv 62 signal 0 } 
	...
	{ stage1_address0 sc_out sc_lv 20 signal 5 } 
	{ stage1_ce0 sc_out sc_logic 1 signal 5 } 
	{ stage1_we0 sc_out sc_logic 1 signal 5 } 
	{ stage1_d0 sc_out sc_lv 8 signal 5 } 
}
set NewPortList {[ 
