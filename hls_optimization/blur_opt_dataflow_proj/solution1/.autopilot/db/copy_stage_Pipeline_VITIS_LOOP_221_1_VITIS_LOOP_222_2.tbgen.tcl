set moduleName copy_stage_Pipeline_VITIS_LOOP_221_1_VITIS_LOOP_222_2
set isTopModule 0
...
set cdfgNum 12
set C_modelName {copy_stage_Pipeline_VITIS_LOOP_221_1_VITIS_LOOP_222_2}
...
dict set ap_memory_interface_dict stage0 { MEM_WIDTH 8 MEM_SIZE 1048576 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ bound int 62 regular  }
	{ width int 32 regular  }
	{ input_r int 8 regular {array 1048576 { 1 3 } 1 1 }  }
	{ stage0 int 8 regular {array 1048576 { 0 3 } 0 1 } {global 1}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "bound", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "stage0", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ stage0_address0 sc_out sc_lv 20 signal 3 } 
	{ stage0_ce0 sc_out sc_logic 1 signal 3 } 
	{ stage0_we0 sc_out sc_logic 1 signal 3 } 
	{ stage0_d0 sc_out sc_lv 8 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stage0_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "stage0", "role": "we0" }} , 
 	{ "name": "stage0_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "stage0", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	stage0 { ap_memory {  { stage0_address0 mem_address 1 20 }  { stage0_ce0 mem_ce 1 1 }  { stage0_we0 mem_we 1 1 }  { stage0_d0 mem_din 1 8 } } }
}
