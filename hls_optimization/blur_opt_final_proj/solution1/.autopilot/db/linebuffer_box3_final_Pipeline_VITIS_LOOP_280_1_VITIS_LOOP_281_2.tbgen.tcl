set moduleName linebuffer_box3_final_Pipeline_VITIS_LOOP_280_1_VITIS_LOOP_281_2
set isTopModule 0
...
set cdfgNum 7
set C_modelName {linebuffer_box3_final_Pipeline_VITIS_LOOP_280_1_VITIS_LOOP_281_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	{ "Name" : "mul_ln280", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mul_ln280 sc_in sc_lv 62 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mul_ln280", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "mul_ln280", "role": "default" }} , 
...
set ArgLastReadFirstWriteLatency {
	linebuffer_box3_final_Pipeline_VITIS_LOOP_280_1_VITIS_LOOP_281_2 {
		empty {Type I LastRead 0 FirstWrite -1}
		mul_ln280 {Type I LastRead 0 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	mul_ln280 { ap_none {  { mul_ln280 in_data 0 62 } } }
