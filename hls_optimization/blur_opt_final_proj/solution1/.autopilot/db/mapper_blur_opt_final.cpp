...
using hls::sim::Byte;
extern "C" void blur_opt_final(Byte<1>*, Byte<1>*, int, int);
extern "C" void apatb_blur_opt_final_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, int __xlx_apatb_param_width, int __xlx_apatb_param_height) {
...
__xlx_output_r__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_output_r)[i]);
  ...
  // DUT call
  blur_opt_final(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data(), __xlx_apatb_param_width, __xlx_apatb_param_height);
